...
exports.initializeRedis = exports.redisClient = void 0;
...
class RedisClient {
    ...
    async cacheProductsList(cacheKey, products) {
        await this.setJSON(cacheKey, products, 3600); // 1 hour
    }
    async getCachedProductsList(cacheKey) {
