...
('Women''s Fashion', 'women', 'Trendy fashion for modern women', 1, true),
('Men''s Fashion', 'men', 'Stylish clothing and accessories for men', 2, true),
('Food & Beverages', 'food-beverages', 'Premium quality food and beverages', 3, true)
...
DECLARE
  ...
  food_id UUID;
BEGIN
  SELECT id INTO women_fashion_id FROM categories WHERE slug = 'women';
  SELECT id INTO men_fashion_id FROM categories WHERE slug = 'men';
  SELECT id INTO food_id FROM categories WHERE slug = 'food-beverages';
  
  -- Insert Women's Fashion Product: Girls Dashiki
  ...
  -- Insert Men's Fashion Product: Boys Dashiki
  INSERT INTO products (
    name, slug, description, short_description, sku, price, 
    category_id, inventory_quantity, status, images, tags,
    track_inventory, allow_backorder, requires_shipping, is_digital,
  ...
  -- Insert Food & Beverages Product: Banku Flour
  INSERT INTO products (
    name, slug, description, short_description, sku, price, 
    category_id, inventory_quantity, status, images, tags,
    track_inventory, allow_backorder, requires_shipping, is_digital,
  ...
  -- Insert Food & Beverages Product: Banku Mix
  INSERT INTO products (
    name, slug, description, short_description, sku, price, 
    category_id, inventory_quantity, status, images, tags,
    track_inventory, allow_backorder, requires_shipping, is_digital,
  ...
  -- Insert Food & Beverages Product: Barbeque
  INSERT INTO products (
    name, slug, description, short_description, sku, price, 
    category_id, inventory_quantity, status, images, tags,
    track_inventory, allow_backorder, requires_shipping, is_digital,
