  ...
  return (
    <ErrorBoundary>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-8 w-full overflow-x-hidden">
        ...
        {products.length > 0 ? (
          <ErrorBoundary>
            <div className={viewMode === 'grid' ? 'grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 sm:gap-6 w-full overflow-x-hidden' : 'space-y-6'}>
