...
export default function ProductCard({ product }: ProductCardProps) {
  ...
  return (
    <div 
      className="bg-white rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 overflow-hidden w-[275px] h-[375px] flex flex-col"
    >
      {/* Product Image */}
      <div className="relative flex-shrink-0 overflow-hidden bg-gray-100 rounded-t-xl h-[200px]">
        <Image
      ...
      <div className="p-4 flex-1 flex flex-col overflow-hidden">
        ...
        <div className="space-y-2 flex-1">
          {/* Product Name */}
          <h3 className="text-sm font-medium text-gray-900 line-clamp-2 hover:text-blue-600 transition-colors cursor-pointer overflow-hidden">
            {product.name}
          </h3>
