...
export default function ProductCard({ product, showQuantitySelector = false }: ProductCardProps): React.JSX.Element {
  ...
  return (
    ...
    <div 
      ...
      className="bg-white rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 overflow-hidden w-full max-w-[275px] sm:w-[275px] aspect-[4/5] flex flex-col"
